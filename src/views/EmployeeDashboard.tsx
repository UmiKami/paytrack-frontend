    ...
    return (
        <div className="p-6">
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div className="text-lg font-bold">Leave History</div>
                <div className="text-lg font-bold">Create New Leave Request</div>
                <hr className="my-4" />
                <div className="text-lg font-bold">Payroll</div>
                <div className="text-lg font-bold">View Payroll Records</div>
                <hr className="my-4" />
                <div className="text-lg font-bold">Attendance</div>
                <div className="text-lg font-bold">View Attendance Records</div>
